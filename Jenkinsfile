...
pipeline {
  ...
  parameters {
    string(name: 'csmRpmRef', defaultValue: "release/1.0", description: 'The branch or ref to use when checking out csm-rpm repo for repo list and package lock versions')
