...
* `suse/x86_64/shasta-pre-install-toolkit-sle15sp2`
...
`suse/x86_64/shasta-pre-install-toolkit-sle15sp2` description:
...
is: `suse/x86_64/shasta-pre-install-toolkit-sle15sp2`. Modify the content within that
